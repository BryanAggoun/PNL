...
/**
  ...
  */
static struct commit *insert_commit(struct commit *from, struct commit *new, struct history *h)
{
...
/**
  ...
  * @return: retourne un pointeur vers la structure inseree
  */
struct commit *add_minor_commit(struct commit *from, char *comment, struct history *h)
{
	/* TODO : Exercice 3 - Question 3 */
  struct commit *c;
  unsigned long m;
...
/**
  ...
  * @return: retourne un pointeur vers la structure inseree
  */
struct commit *add_major_commit(struct commit *from, char *comment, struct history *h)
{
	/* TODO : Exercice 3 - Question 3 */
  struct commit *c;
  unsigned long m;
...
/**
  ...
  */
struct commit *del_commit(struct commit *victim, struct history *h)
{
